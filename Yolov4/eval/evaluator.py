...
class Evaluator(object):
    def __init__(self, model, showatt, result_path):
        ...
        self.pred_result_path = os.path.join(result_path, "pred_result")
    ...
    def APs_voc(self, multi_test=False, flip_test=False):
        ...
        output_path = os.path.join(self.result_path, 'output') 
        ...
        for img_ind in tqdm(img_inds):
            ...
            f = open(output_path + "/" + img_ind + ".txt", "w")
        ...
        return self.__calc_all_APs(), self.inference_time
    ...
    def __calc_all_APs(self, use_07_metric=True):
        """
        ...
        APs_dict = {50: 0, 55: 0, 60: 0, 65: 0, 70: 0, 75: 0, 80: 0, 85: 0, 90: 0, 95: 0}
        for th in range(50, 100, 5):
            print("Eval the:{}".format(th))
            threshold = th / 100
            ...
            for i, cls in enumerate(self.classes):
                R, P, AP = voc_eval.voc_eval(filename, annopath, imagesetfile, cls, 
                                             cachedir, threshold, use_07_metric)
                Recalls[cls] = R
                Precisions[cls] = P
                APs[cls] = AP
            APs_dict[th] = APs
    ...
    # def __calc_APs(self, iou_thresh=0.75, use_07_metric=True):
    #     """
    #     Calculate ap values for each category
    #     :param iou_thresh:
    #     :param use_07_metric:
