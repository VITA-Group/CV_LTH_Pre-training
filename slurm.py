...
qos_dict = {"sailon" : {"nhrs" : 72, "cores": 16, "mem":128},
...
parser.add_argument('--env', default="motif", type=str, help = "Set the name of the dir you want to dump")
    ...
    for dataset in datasets:
        for j, weights in enumerate(weights_dir):
            ...
            for i, (ratio) in enumerate(params):
                ...
                cmd = f"python -u main_eval_downstream.py --dataset {dataset} --arch resnet50 --save_dir weights/{dataset}_{num}  --dict_key state_dict  --mask_dir {weights} --save_model --few_shot_ratio {ratio}"
...
with open(slurm_script_path, 'w') as slurmfile:
    ...
    slurmfile.write("conda activate /fs/vulcan-projects/sailon_root/miniconda3/envs/OSU\n")
